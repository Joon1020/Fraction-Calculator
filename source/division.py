...
def division(whole_number_1, numerator_1, denominator_1, whole_nubmer_2, numerator_2, denominator_2):
   try:
      ...
      last_numerator = numerator_1 * denominator_2 # 나눗셈
      common_denominator = denominator_1 * numerator_2
